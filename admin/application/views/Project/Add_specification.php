		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<?php if($SpecificationId==1)
					{
						echo	"Edit Specification";
					}
					else{
					...
					<a href="<?php echo base_url();?>project/list_specification/" class="btn btn-black" style="float:right">Back to Specification List</a>
				</div>
				</h4>
				<div class="card-body collapse in">
					<div class="card-block">
						<form class="form" method="post" enctype="multipart/form-data" id="frm_specification" action="<?php echo base_url();?>project/add_specification">
							<div class="form-body">
								<h4 class="form-section"><i class="icon-clipboard4"></i> Requirements</h4>
								<div class="form-group">
								<input type="hidden" value="<?php echo $SpecificationId; ?>" name="SpecificationId">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="spectitle" id="spectitle" value="<?php echo $SpecificationTitle; ?>">
								</div>
								<div class="form-group">
									<label>Specification Notes</label>
									<textarea name="specdesc" id="specdesc" class="form-control" ><?php echo $SpecificationDesc; ?></textarea>
								</div>
								<div class="form-group">
							...
							<div class="form-actions">
									 <button class="btn btn-black " type="submit"><i class="icon-ok"></i> <?php echo ($SpecificationId!='')?'Update':'Submit' ?></button>
