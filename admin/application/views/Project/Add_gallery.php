		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url();?>project/list_gallery/" class="btn btn-black" style="float:right">Back to Gallery List</a>
				</div>
				</h4>
				<div class="card-body collapse in">
					<div class="card-block">
				
						<form class="form" method="post" enctype="multipart/form-data" id="frm_project" action="<?php echo base_url();?>project/add_gallery">
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="hidden" name="pre_gallery_image" value="<?php echo $GalleryImage;?>">
									Upload gallery image<input type="file" name="GalleryImages" id="galleryImage" onchange="readURLimg(this);">
									</span></p>									
									<span id="galleryerrorimg"></span>
								</div>
								<div class="preview">									
									<?php if($GalleryImage){ ?>
									<img id="blahimg" src="<?php echo base_url()?>upload/galleryimage/<?php echo $GalleryImage;?>" class="img-thumbnail border-0" style="display: block;  width: 100px; height: 100px;">
									<?php } else{?>
							...
							<div class="form-actions">
									 <button class="btn btn-black " type="submit"><i class="icon-ok"></i> <?php echo ($GalleryId!='')?'Update':'Submit' ?></button>
