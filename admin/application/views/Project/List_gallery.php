    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Gallery
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="<?php echo base_url();?>project/add_gallery/" class="btn btn-black" style="float:right">Add Gallery</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php  if($row->gallery_image){ ?>
                                        <input type="hidden" name="galleryimage" id="galleryimage" value="<?php echo $row->gallery_image;?>">
                                          <img id="blahlogo" src="<?php echo base_url()?>upload/galleryimage/<?php echo $row->gallery_image;?>" class="img-thumbnail border-0" style="display: block;  width: 50px; height: 50px;">
                                        <?php }else { echo "N/A" ?>
            ...
            //galleryimage=$('#galleryimage').val();
               ...
               // alert(url);
                ...
                success: function (response) {   
                    ...
                    //return false;   
                    if(response==true){
                      document.location.href = url+'project/list_gallery';    
                    } 
            },
