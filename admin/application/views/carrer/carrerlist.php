                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <?php echo anchor('carrer/editcarrer/'.$row->CarrerId,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a onclick="deletedata('<?php echo $row->CarrerId; ?>')" ><i class="ficon icon-bin"></i></a>    
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
...
function deletedata(CarrerId){  
    $('#myModal').modal('show');
  // alert(id);
        $('#yes_btn').click(function(){
                url="<?php echo base_url();?>carrer/carrer_delete/";
                $.ajax({
                url: url,
                type: "post",
                data: {CarrerId:CarrerId} ,
