		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url();?>project/list_projectslider/" class="btn btn-black" style="float:right">Back to Gallery List</a>
				</div>
				</h4>
				<div class="card-body collapse in">
					<div class="card-block">
				
						<form class="form" method="post" enctype="multipart/form-data" id="frm_project" action="<?php echo base_url();?>project/add_projectslider">
					
							<div class="form-body">
								<h4 class="form-section"><i class="icon-clipboard4"></i> Requirements</h4>
							
								<div class="form-group">
								<input type="hidden" value="<?php echo $projectslider_id; ?>" name="projectslider_id">
								...
								<div class="form-group">
									...
									<input type="hidden" name="pre_projectslider_image" value="<?php echo $projectslider_img;?>">
									Upload image<input type="file" name="ProjectsliderImages" id="ProjectsliderImages" onchange="readURLimg(this);">
									</span></p>									
									<span id="projectslidererrorimg"></span>
								</div>
								<div class="preview">									
									<?php if($projectslider_img){ ?>
									<img id="blahimg" src="<?php echo base_url()?>upload/projectimage/<?php echo $projectslider_img;?>" class="img-thumbnail border-0" style="display: block;  width: 100px; height: 100px;">
									<?php } else{?>
							...
							<div class="form-actions">
									 <button class="btn btn-black " type="submit"><i class="icon-ok"></i> <?php echo ($projectslider_id!='')?'Update':'Submit' ?></button>
   ...
   // console.log(value);
	...
	$("#frm_project").validate(
	{
		...
		rules:
		{
			...
			{
				required:function(){
                   galleryimage='<?php echo $projectslider_img; ?>';
                   if(galleryimage){
                    	return false;
                   }else{
               			return true;
		 ...
		 errorPlacement: function (error, element) {
            ...
            if (element.attr("name") == "ProjectsliderImages") {
                error.appendTo("#projectslidererrorimg");
            } else{
